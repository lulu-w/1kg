...
mapply(write.table, pop_geneExp, 
       file = paste0("./temp/geneExp_", names(pop_geneExp), "_", chunkName, ".txt"), 
...
for(i in 1:length(pop_geneExp)){
    ...
    expression_file_name = paste0("./temp/geneExp_", xgroup, "_", chunkName, ".txt")
