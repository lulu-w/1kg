...
abline(v=-log10(4.7e-7), col = "orange", lty=2)
...
### Figure 4A Individual TF and Target Expression
...
### Figure 4B TF target gene expression
...
#res1 = extractTarget(res[[1]], te = sel$te[which(sel$tf == names(res)[1])])
res1 = mapply(extractTarget, res, te = sel$te[order(sel$tf)])

lapply(res1, plotHeatmap)
